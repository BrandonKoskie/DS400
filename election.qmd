...
The prior model shows your belief about a parameter before seeing the data. The likelihood function comes from observed data and tells us how likeley the data is for different parameter values.
...
The posterior represents your updated belief about a parameter. It more agrees with the prior due to it those two being closer together.
